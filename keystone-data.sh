...
QUANTUM_SERVICE=$(keystone service-create --name quantum --type network --description "OpenStack Networking Service" | grep " id " | get_field 2)
...
keystone endpoint-create --region $KEYSTONE_REGION --service_id $GLANCE_SERVICE \
                                           --publicurl "http://$SERVICE_URL:9292/" \
                                           --adminurl "http://$SERVICE_URL:9292/" \
                                           --internalurl "http://$SERVICE_URL:9292/"
...
## Quantum
keystone endpoint-create --region $KEYSTONE_REGION --service_id $QUANTUM_SERVICE \
                                           --publicurl "http://$SERVICE_URL:9696/" \
                                           --adminurl "http://$SERVICE_URL:9696/" \
                                           --internalurl "http://$SERVICE_URL:9696/"
